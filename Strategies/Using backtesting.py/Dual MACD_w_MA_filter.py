...
class DualMACDStrategy(Strategy):
    ...
    def init(self) :
        self.MA200 = self.I(ta.sma, pd.Series(self.data.Close), self.ma_period)
    ...
    def next(self):
        ...
        if weekly_MACDfast > weekly_MACDsig and close_price > self.MA200: # Trading "window" open
...
print(f'\nMA Filter Period: {strategy.ma_period}') # Idea parameter from optimization
#bt.plot()