...
def get_price_data(parameter_data):
    ...
    weekly_returns = daily_returns.resample('W').sum().fillna(0) # Need to subtract 1 to get actual % returns.
    monthly_returns = daily_returns.resample('M').sum().fillna(0) # Need to subtract 1 to get actual % returns.
