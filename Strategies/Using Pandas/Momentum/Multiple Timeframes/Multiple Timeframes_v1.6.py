...
def optimize(price_data,parameter_data,performance_data):
    ...
    print(f'  Parameter ranges to optimize:', flush=True)
    for param_to_optimize, val in params_to_optimize.items(): # Select a parameter to optimize by testing a range of values
        ...
        print(f'    {param_to_optimize}  val: {val}')
...
def main():
    ...
    parameter_data1 = DataClassParameters(run_number=1,benchmark_sma_short=(8),benchmark_sma_long=(160),rolling_period_long=(13),
