...
def get_price_data(parameter_data):
    ...
    daily_prices_df = all_daily_prices_df.copy()#.dropna(axis=1) # Drop any stocks that are missing values <-- bad idea since it will skew our data
...
class DataClassParameters:
    ...
    run_max: int = 8 #8 #4 # How many times to run th eoptimization function
